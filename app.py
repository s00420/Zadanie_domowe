...
with st.sidebar:
    ...
    st.markdown("Jeżeli chcesz znaleźć grupę osób które mają podobne zainteresowania, wypełnij poniższą ankietę:")
...
st.header(f"Gratulacje! Dołączyłeś do grupy {predicted_cluster_data['name']}")
